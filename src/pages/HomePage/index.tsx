...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('pages.home.title')} | {t('common.appName')}</title>
      ...
      <HomeContainer>
        <HeroSection>
          <HeroContent>
            <HeroTitle>{t('pages.home.welcome')}</HeroTitle>
            <HeroSubtitle>
        ...
        <FeaturesSection>
          <h2>{t('pages.home.keyFeatures', 'Key Features')}</h2>
          <FeaturesList>
            <FeatureItem>
              <Card 
                hoverable 
        ...
        <CtaSection>
          <Card shadow="md">
            ...
            >
              {t('pages.home.learnMore', 'Learn More')}
            </Button>
          </Card>
        </CtaSection>
      </HomeContainer>
